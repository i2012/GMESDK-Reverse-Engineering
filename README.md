...
> [!CAUTION]
> **2026-5-22下午有人发现服务器对该文件下发了完整性校验，hash不一致会导致客户端弹出`Error Code: (2,0,4)`错误，虽然目前已经找到了一种无需Hook无需修改任何文件的绕过漏洞，但由于该方法一旦公开很可能会被快速修复，所以我们决定不再理会此类问题，也不会更新任何解决方法，本项目仅用于教育和研究目的，请遵守相关软件的用户协议和当地法律法规❗️**
